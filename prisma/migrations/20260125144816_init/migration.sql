...
-- CreateEnum
CREATE TYPE "ApplicationStatus" AS ENUM ('PENDING', 'REVIEWED', 'INTERVIEW_SCHEDULED', 'REJECTED', 'HIRED');
...
CREATE TABLE "Jobs" (
    ...
    "location" "JobLocationType" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Jobs" ADD CONSTRAINT "Jobs_postedBy_fkey" FOREIGN KEY ("postedBy") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
